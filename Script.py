class script(object):
    START_TXT = """<b>​​​<blockquote><blockquote>ʜɪɪ {} 👋, 
ɪ ᴀᴍ ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟʟ ᴍᴇᴅɪᴀ ᴘʀᴏᴠɪᴅᴇʀ ʙᴏᴛ. ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇᴅ ᴀʟʟ ʟᴀᴛᴇꜱᴛ ᴍᴏᴠɪᴇꜱ ᴏʀ ꜱᴇʀɪᴇꜱ. ᴊᴜꜱᴛ ꜱᴇɴᴅ ᴍᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ɴᴀᴍᴇ .</Regular></Regular></b>"""
...
╰───────────────⍟</b>"""
    ...
    FORCESUB_TEXT="""<b><blockqoute>
ᴊᴏɪɴ ᴏᴜʀ ᴏғғɪᴄɪᴀʟ ᴄʜᴀɴɴᴇʟ.
ᴄʟɪᴄᴋ ☛ "Jᴏɪɴ ᴜᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ" ʙᴜᴛᴛᴏɴ, ᴛʜᴇɴ, ᴄʟɪᴄᴋ ☛ "ʀᴇᴏ̨ᴜᴇsᴛ ᴛᴏ Jᴏɪɴ" ʙᴜᴛᴛᴏɴ.
...
3:- ᴄʀᴇᴀᴛᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ ᴀɴʏ sʜᴏʀᴛɴᴇʀ ʟɪᴋᴇ ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴜsᴇ ᴛʜɪs ʙᴇsᴛ sʜᴏʀᴛɴᴇʀ <a href=https://adrinolinks.in/ref/adityapatel38287>adrinolinks</a>.
...
ɪᴛ ʜᴀꜱ ᴇɪᴛʜᴇʀ ɴᴏᴛ ʙᴇᴇɴ ʀᴇʟᴇᴀꜱᴇᴅ ᴏʀ ʜᴀꜱ ɴᴏᴛ ʏᴇᴛ ʙᴇᴇɴ ᴀᴅᴅᴇᴅ ᴛᴏ ᴛʜᴇ ᴅᴀᴛᴀʙᴀꜱᴇ.</i></b>"""
    ...
    TOP_ALRT_MSG = """𝐒𝐞𝐚𝐫𝐜𝐡𝐢𝐧𝐠 𝐢𝐧 𝐦𝐲 𝐃𝐚𝐭𝐚𝐛𝐚𝐬𝐞..."""
...
•─────•─────────•─────•
🏷️ <a href='https://t.me/Movie_Help24_Bot'>ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ᴘʀᴏᴏꜰ</a>
...
ɪꜰ ʏᴏᴜ ꜰᴀᴄᴇ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ, ᴛᴀᴋᴇ ᴀ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ ᴀɴᴅ ꜱᴇɴᴅ ɪᴛ ᴛᴏ - @Movie_Help24_Bot
...
💳 ᴜᴘɪ ɪᴅ - <blockquote><b><code>adityapatel2463@okicici</code></b></blockquote>
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<Regular><b><a href="https://t.me/moviemagic_24">{file_name}</a></b></blockquote>\n\n<b> ❤️‍🔥𝗝𝗼𝗶𝗻 𝗨𝘀 : <a href="https://t.me/moviemagic_24"> Movie Magic🤩 </a></b>"""
...
• /details - ᴄʜᴇᴄᴋ ʏᴏᴜʀ ꜱᴇᴛᴛɪɴɢꜱ."""    
    ...
    SOURCE_TXT = """<b>𝗦𝗢𝗨𝗥𝗖𝗘 𝗖𝗢𝗗𝗘 :</b> 👇\n𝐓𝐡𝐢𝐬 𝐢𝐬 𝐧𝐨𝐭 𝐚 𝐎𝐩𝐞𝐧-𝐒𝐨𝐮𝐫𝐜𝐞 𝐏𝐫𝐨𝐣𝐞𝐜𝐭.𝐘𝐨𝐮 𝐜𝐚𝐧 𝐮𝐬𝐞 𝐢𝐭 𝐅𝐫𝐞𝐞𝐥𝐲 𝐨𝐧𝐥𝐲 𝐁𝐮𝐭 𝐢𝐟 𝐲𝐨𝐮 𝐏𝐮𝐫𝐜𝐡𝐚𝐬𝐞 𝐑𝐄𝐏𝐎 𝐟𝐨𝐫 𝐂𝐨𝐧𝐭𝐚𝐜𝐭<blockquote><b> ☞ @Movie_Help24_Bot</b></blockquote>"""
