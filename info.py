...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://adipatel2463:<adipatel2463>@cluster0.ecndm.mongodb.net/?appName=Cluster0")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviemagics2')
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/moviemagic_24")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/moviemagic_24")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/moviemagic_24")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Movie_Help24_Bot') 
...
IGNORE_WORDS= ["movies", "Movies", ",", "/", "movie", "please", "Movie", ".", "episode", "Episode", "episodes", "today episode", "Today Episode", " Today's Episode", "2025 wali", "Episodes", "south indian", "south indian movie", "South Indian Movie", "south movie", "South Movie", "South Indian", "web-series", "hindi me bhejo", "gujrati", "combined", "!", "kro", "jaldi", "Audio", "audio", "movi", "language", "Language", "Hollywood", "All", "all", "bollywood", "Bollywood", "South", "south", "HD", "hd", "karo", "Karo", "fullepisode", "please", "plz", "Please", "Plz", "send", "link", "Link", "full", "Full", "dabbed", "dubbed", "season", "Season", "web", "series", "Web", "Series", "webseries", "WebSeries", "upload", "HD", "Hd", "bhejo", "ful", "Send", "Bhejo"]

BAD_WORDS = ["Hdhub4u", "cinevood", "skymoviedHD,","original","tg", "www","villa", "join", "PrivateMovieZ","toonworld4all", "themoviesboss", "1tamilmv", "tamilblasters", "1tamilblasters", "skymovieshd", "extraflix", "hdm2", "moviesmod", "hdhub4u", "mkvcinemas", "www", "join", "primefix", "sbanime", "sbanimes"] #Remove Words From File_Name
